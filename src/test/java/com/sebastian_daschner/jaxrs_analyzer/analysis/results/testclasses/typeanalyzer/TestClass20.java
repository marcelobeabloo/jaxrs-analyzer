...
public class TestClass20 implements Interface1, Interface2 {
    ...
    public static Set<TypeRepresentation> expectedTypeRepresentations() {
        ...
        properties.put("test1", TypeDefinition.of(TypeUtils.STRING_IDENTIFIER));
        properties.put("test2", TypeDefinition.of(TypeUtils.STRING_IDENTIFIER));
        properties.put("test3", TypeDefinition.of(TypeUtils.STRING_IDENTIFIER));
        properties.put("test4", TypeDefinition.of(TypeUtils.STRING_IDENTIFIER));
